 ...
 */
@ConvertAsProperties(
        dtd = "-//com.whitesheep.crud//AimCRUD//EN",
        autostore = false
)
...
@ActionID(
        category = "Window", 
        id = "com.whitesheep.crud.AimCRUD")
@ActionReference(
        path = "Menu/Window/Entity Manager")
@TopComponent.OpenActionRegistration(
        displayName = "#CTL_AimCRUDAction",
        preferredID = "AimCRUD"
)
@NbBundle.Messages({
    "CTL_AimCRUDAction=Aim Manager",
    "CTL_AimCRUDTopComponent=Aim Manager",
    "HINT_AimCRUDTopComponent=This is a Aim Manager window"
})
public class AimCRUD extends TopComponent implements Lookup.Provider {
    ...
    public AimCRUD() {
        ...
        initComponents();
        setName(Bundle.CTL_AimCRUDTopComponent());
        setToolTipText(Bundle.HINT_AimCRUDTopComponent());
        associateLookup(new AbstractLookup(dynamicContent));
    }
    
    private List<Aim> findAll(){
    ...
    private void save(){
        ...
        Aim selectedEntity = list.get(selectedModelIdx);
        if (selectedEntity.getAimId() != null){
            Response response = aimClient.edit_JSON(selectedEntity, selectedEntity.getAimId().toString());
            //showDialog(response);
        } else {
            Response response = aimClient.create_JSON(selectedEntity);
            //showDialog(response);
        }
    }
    ...
    private void delete(){
        ...
        Aim selectedEntity = list.get(selectedModelIdx);
        if (selectedEntity.getAimId() != null){
            Response response = aimClient.remove(selectedEntity.getAimId().toString());
            //showDialog(response);
        }
    }
    ...
    private void initComponents() {
        ...
        aimIdField = new javax.swing.JTextField();
        ...
        org.jdesktop.swingbinding.JTableBinding.ColumnBinding columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${aimId}"));
        ...
        org.openide.awt.Mnemonics.setLocalizedText(aimIdLabel, org.openide.util.NbBundle.getMessage(AimCRUD.class, "AimCRUD.aimIdLabel.text_2")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(nameLabel, org.openide.util.NbBundle.getMessage(AimCRUD.class, "AimCRUD.nameLabel.text_2")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(tstampLabel, org.openide.util.NbBundle.getMessage(AimCRUD.class, "AimCRUD.tstampLabel.text_2")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(userNameLabel, org.openide.util.NbBundle.getMessage(AimCRUD.class, "AimCRUD.userNameLabel.text_2")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(saveButton, org.openide.util.NbBundle.getMessage(AimCRUD.class, "AimCRUD.saveButton.text_2")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(refreshButton, org.openide.util.NbBundle.getMessage(AimCRUD.class, "AimCRUD.refreshButton.text_2")); // NOI18N
        refreshButton.addActionListener(formListener);

        org.openide.awt.Mnemonics.setLocalizedText(newButton, org.openide.util.NbBundle.getMessage(AimCRUD.class, "AimCRUD.newButton.text_2")); // NOI18N
        newButton.addActionListener(formListener);

        org.openide.awt.Mnemonics.setLocalizedText(deleteButton, org.openide.util.NbBundle.getMessage(AimCRUD.class, "AimCRUD.deleteButton.text_2")); // NOI18N

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null && selectedElement.aimId != null}"), deleteButton, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        deleteButton.addActionListener(formListener);

        aimIdField.setEditable(false);
        aimIdField.setEnabled(false);

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.aimId}"), aimIdField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setSourceNullValue("");
        binding.setSourceUnreadableValue("");
        bindingGroup.addBinding(binding);
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(aimIdField, javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                AimCRUD.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                AimCRUD.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                AimCRUD.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                AimCRUD.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        com.whitesheep.entity.Aim a = new com.whitesheep.entity.Aim();
        list.add(a);
        int row = list.size() - 1;
    ...
    private javax.swing.JTextField aimIdField;
    private javax.swing.JLabel aimIdLabel;
    private javax.swing.JButton deleteButton;
    private javax.persistence.EntityManager entityManager;
    private java.util.List<com.whitesheep.entity.Aim> list;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AimCRUD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new AimCRUD());
